...
@DatasetReader.register("conditioned_cnndmail_dataset_reader")
class CNNDmailDatasetReader(DatasetReader):
    ...
    def dict_to_instance(self, dp):
        ...
        section_label = dp["section"]
        return self.text_to_instance(source_sequence, target_sequence, section_label)
    ...
    @overrides
    def text_to_instance(self, source_string: str, target_string: str = None, section_label: str = None) -> Instance:  # type: ignore
        """
        ...
        section_field = LabelField(section_label, label_namespace="section_labels")
        
        meta_fields = {"source_tokens": [x.text for x in tokenized_source]}
        fields_dict = {
                "source_tokens": source_field,
                "section_labels": section_field,
        }
